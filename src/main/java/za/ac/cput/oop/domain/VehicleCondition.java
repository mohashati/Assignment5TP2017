...
public class VehicleCondition implements Serializable{
    ...
    public VehicleCondition(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public Builder copy(VehicleCondition addressEmbeddable)
        {
        ...
        public VehicleCondition build()
        {
            return new VehicleCondition(this);
        }
    }
